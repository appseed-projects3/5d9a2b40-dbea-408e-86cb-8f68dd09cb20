...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-19 10:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5d9a2b40-dbea-408e-86cb-8f68dd09cb20.git
$ cd 5d9a2b40-dbea-408e-86cb-8f68dd09cb20
```
